...
#ifndef TRACKING_MSGS__MSG__TRACKED_OBSTACLE_LIST_H_
#define TRACKING_MSGS__MSG__TRACKED_OBSTACLE_LIST_H_
...
#endif  // TRACKING_MSGS__MSG__TRACKED_OBSTACLE_LIST_H_
