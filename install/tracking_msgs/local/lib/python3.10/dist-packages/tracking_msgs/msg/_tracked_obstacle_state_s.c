...
bool tracking_msgs__msg__tracked_obstacle_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tracking_msgs.msg._tracked_obstacle_state.TrackedObstacleState", full_classname_dest, 62) == 0);
  }
  tracking_msgs__msg__TrackedObstacleState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TrackedObstacleState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tracking_msgs.msg._tracked_obstacle_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackedObstacleState");
