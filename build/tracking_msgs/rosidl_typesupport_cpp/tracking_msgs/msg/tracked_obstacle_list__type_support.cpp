...
static const _TrackedObstacleList_type_support_symbol_names_t _TrackedObstacleList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tracking_msgs, msg, TrackedObstacleList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tracking_msgs, msg, TrackedObstacleList)),
  }
};
...
{
  return &::tracking_msgs::msg::rosidl_typesupport_cpp::TrackedObstacleList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tracking_msgs, msg, TrackedObstacleList)() {
  return get_message_type_support_handle<tracking_msgs::msg::TrackedObstacleList>();
}
