...
#include "tracking_msgs/msg/detail/tracked_detection3_d__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_msgs/msg/detail/detection3_d__functions.h"  // detection, observation_history, predicted_states
...
using _TrackedDetection3D__ros_msg_type = tracking_msgs__msg__TrackedDetection3D;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrackedDetection3D__ros_msg_type * ros_message = static_cast<const _TrackedDetection3D__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrackedDetection3D__ros_msg_type * ros_message = static_cast<_TrackedDetection3D__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: observation_history
  {
    ...
    if (ros_message->observation_history.data) {
      vision_msgs__msg__Detection3D__Sequence__fini(&ros_message->observation_history);
    }
  ...
  // Field name: predicted_states
  {
    ...
    if (ros_message->predicted_states.data) {
      vision_msgs__msg__Detection3D__Sequence__fini(&ros_message->predicted_states);
    }
...
static uint32_t _TrackedDetection3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tracking_msgs__msg__TrackedDetection3D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tracking_msgs__msg__TrackedDetection3D;
    is_plain =
      (
...
static size_t _TrackedDetection3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tracking_msgs__msg__TrackedDetection3D(
...
static message_type_support_callbacks_t __callbacks_TrackedDetection3D = {
  "tracking_msgs::msg",
  "TrackedDetection3D",
...
static rosidl_message_type_support_t _TrackedDetection3D__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackedDetection3D,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tracking_msgs, msg, TrackedDetection3D)() {
  return &_TrackedDetection3D__type_support;
}
