...
#include "tracking_msgs/msg/detail/obstacle_list__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tracking_msgs::msg::ObstacleList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tracking_msgs::msg::ObstacleList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tracking_msgs::msg::ObstacleList *>(
    untyped_ros_message);
...
{
  return &tracking_msgs::msg::typesupport_fastrtps_cpp::_ObstacleList__handle;
}
